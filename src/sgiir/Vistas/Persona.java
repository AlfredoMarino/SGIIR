 ...
 */
@Entity
@Table(name = "persona", catalog = "SGIIRDB", schema = "")
@NamedQueries({
...
public class Persona implements Serializable {
    ...
    public Persona(Integer codigoPersona, String nombrePersona, String emailPersona, long telefonoPersona, int codigoCargo, boolean recordatorioPersona) {
        this.codigoPersona = codigoPersona;
    ...
    public void setCodigoCargo(int codigoCargo) {
        int oldCodigoCargo = this.codigoCargo;
        this.codigoCargo = codigoCargo;
    ...
    public String toString() {
        return "sgiir.Vistas.Persona[ codigoPersona=" + codigoPersona + " ]";
    }
