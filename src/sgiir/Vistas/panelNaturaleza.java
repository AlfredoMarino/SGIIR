...
public class panelNaturaleza extends JPanel {
    ...
    private void initComponents() {
        ...
        columnBinding.setColumnClass(Integer.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${codigoCaracteristica}"));
        columnBinding.setColumnName("Codigo Caracteristica");
        columnBinding.setColumnClass(Integer.class);
        ...
        columnBinding.setColumnClass(java.util.Date.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${carpetaEvento}"));
        columnBinding.setColumnName("Carpeta Evento");
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${observacionEvento}"));
        columnBinding.setColumnName("Observacion Evento");
        columnBinding.setColumnClass(String.class);
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == newButton) {
                ...
                panelNaturaleza.this.deleteDetailButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newDetailButton) {
                panelNaturaleza.this.newDetailButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteDetailButtonActionPerformed
        ...
        sgiir.Naturaleza n = list.get(masterTable.convertRowIndexToModel(index));
        Collection<sgiir.Vistas.Tarea> ts = n.getTareaCollection();
        int[] selected = detailTable.getSelectedRows();
        List<sgiir.Vistas.Tarea> toRemove = new ArrayList<sgiir.Vistas.Tarea>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            selected[idx] = detailTable.convertRowIndexToModel(selected[idx]);
            int count = 0;
            Iterator<sgiir.Vistas.Tarea> iter = ts.iterator();
            while (count++ < selected[idx]) {
                iter.next();
            }
            sgiir.Vistas.Tarea t = iter.next();
            toRemove.add(t);
    ...
    private void newDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newDetailButtonActionPerformed
        ...
        Collection<sgiir.Vistas.Tarea> ts = n.getTareaCollection();
        if (ts == null) {
            ts = new LinkedList<sgiir.Vistas.Tarea>();
            n.setTareaCollection((List) ts);
        }
        sgiir.Vistas.Tarea t = new sgiir.Vistas.Tarea();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<sgiir.Naturaleza> toRemove = new ArrayList<sgiir.Naturaleza>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            sgiir.Naturaleza n = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(n);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        sgiir.Naturaleza n = new sgiir.Naturaleza();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<sgiir.Naturaleza> merged = new ArrayList<sgiir.Naturaleza>(list.size());
            for (sgiir.Naturaleza n : list) {
    ...
    private java.util.List<sgiir.Naturaleza> list;
