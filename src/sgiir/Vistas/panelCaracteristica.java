...
public class panelCaracteristica extends JPanel {
    ...
    public panelCaracteristica() {
     ...
     public void setCaracteristica(int CodigoNaturaleza, int CodigoTarea) {
        ...
        //query = entityManager.createQuery("SELECT c.CodigoNaturaleza FROM Caracteristica where CodigoNaturaleza = 2");
        //query.setParameter("codigoNaturaleza", new Naturaleza(CodigoNaturaleza));
        //query.setParameter("codigoTarea", new Tarea(CodigoTarea));
    ...
    private void initComponents() {
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), tareaField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.area.descripcionArea}"), areaField, org.jdesktop.beansbinding.BeanProperty.create("text"));
