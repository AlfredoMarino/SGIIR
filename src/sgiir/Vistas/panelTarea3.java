 ...
 */
public class panelTarea3 extends JPanel {
    ...
    private void initComponents() {
        ...
        org.jdesktop.beansbinding.ELProperty eLProperty = org.jdesktop.beansbinding.ELProperty.create("${naturaleza.tareaCollection}");
        jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, list, eLProperty, detailTable);
        ...
        eLProperty = org.jdesktop.beansbinding.ELProperty.create("${selectedElement.caracteristicaCollection}");
        org.jdesktop.swingbinding.JListBinding jListBinding = org.jdesktop.swingbinding.SwingBindings.createJListBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, detailTable, eLProperty, lstArea);
    ...
    private class FormListener implements java.awt.event.ActionListener, java.awt.event.ItemListener, java.awt.event.MouseListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                panelTarea3.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                panelTarea3.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteDetailButton) {
                panelTarea3.this.deleteDetailButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newDetailButton) {
                panelTarea3.this.newDetailButtonActionPerformed(evt);
            }
            else if (evt.getSource() == jButton1) {
                panelTarea3.this.jButton1ActionPerformed(evt);
            }
            else if (evt.getSource() == jButton2) {
                panelTarea3.this.jButton2ActionPerformed(evt);
            }
            else if (evt.getSource() == jButton3) {
                panelTarea3.this.jButton3ActionPerformed(evt);
            }
            else if (evt.getSource() == rdbPrioridad3) {
                panelTarea3.this.rdbPrioridad3ActionPerformed(evt);
            }
            else if (evt.getSource() == rdbPrioridad2) {
                panelTarea3.this.rdbPrioridad2ActionPerformed(evt);
            }
            else if (evt.getSource() == rdbTipo1) {
                panelTarea3.this.rdbTipo1ActionPerformed(evt);
            }
            else if (evt.getSource() == rdbPrioridad1) {
                panelTarea3.this.rdbPrioridad1ActionPerformed(evt);
            }
        }

        public void itemStateChanged(java.awt.event.ItemEvent evt) {
            if (evt.getSource() == cbxSeguimiento) {
                panelTarea3.this.cbxSeguimientoItemStateChanged(evt);
            }
        }
        ...
        public void mouseReleased(java.awt.event.MouseEvent evt) {
            if (evt.getSource() == detailTable) {
                panelTarea3.this.detailTableMouseReleased(evt);
            }
            else if (evt.getSource() == cbxSeguimiento) {
                panelTarea3.this.cbxSeguimientoMouseReleased(evt);
            }
            else if (evt.getSource() == masterTable) {
                panelTarea3.this.masterTableMouseReleased(evt);
            }
        }
    ...
    private void updateSQL(){
        try {
            ...
            Logger.getLogger(panelTarea3.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(combo.getId() != 0){
            ...
            if(rdbTipo1.isSelected()){
                this.tipoNaturaleza = 0; //INCIDENCIA
            }else{
                this.tipoNaturaleza = 1; //REQUERIMIENTO
            }
            ...
            query.setParameter(1, codigoInstitucion);
            query.setParameter(2, tipoNaturaleza);
            query.setParameter(3, prioridadNaturaleza);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(panelTarea3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new panelTarea3());
